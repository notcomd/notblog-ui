...
export function getCallConnection(): signalR.HubConnection {
...
export async function connectCallSignalR(): Promise<signalR.HubConnection> {
...
export function isCallConnected(): boolean {
