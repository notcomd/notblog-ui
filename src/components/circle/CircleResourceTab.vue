<template>
  ...
  <div class="mt-4">
    ...
    <div v-if="previewIndex >= 0" class="fixed inset-0 z-[70] flex items-center justify-center bg-black/70" @click="previewIndex = -1">
      ...
      <button class="absolute top-4 right-4 w-9 h-9 rounded-full bg-black/50 text-white text-lg flex items-center justify-center hover:bg-black/70" @click="previewIndex = -1"><svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button>
    </div>
  </div>
</template>
