  ...
  <Teleport to="body">
    <div class="fixed top-3 right-3 lg:top-4 lg:right-4 z-[999] flex flex-col items-end gap-2 pointer-events-none" aria-live="polite">
      <TransitionGroup name="notify-slide">
        ...
        >
          <!-- 通知图标 -->
          <div class="w-10 h-10 shrink-0 rounded-[10px] bg-amber-400/15 dark:bg-amber-500/15 flex items-center justify-center text-xl" aria-hidden="true">
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-center justify-between gap-2">
              ...
              >
                <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
              </button>
            </div>
