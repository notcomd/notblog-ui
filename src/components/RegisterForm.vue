<template>
  <div class="w-full max-w-md">
    ...
    <div class="transition-all duration-300">
      <!-- 标题 -->
      <div class="mb-6">
        <h1 class="text-3xl font-bold text-amber-900 dark:text-amber-100 mb-2">注册 NotBlog</h1>
        <p class="text-sm text-amber-600 dark:text-amber-300">创建您的账户，开始记录与分享</p>
      </div>
      ...
      <div class="flex mb-6 bg-amber-50 dark:bg-zinc-800/70 rounded-[5%] p-1 gap-1">
        <button
          ...
          :class="registerMode === 'email' ? 'bg-white text-amber-800 dark:bg-zinc-700 dark:text-amber-200' : 'text-amber-500 hover:text-amber-700 dark:text-amber-400 dark:hover:text-amber-200'"
        ...
        <button
          class="flex-1 py-2 text-sm font-medium rounded-[5%] transition-all duration-200"
          :class="registerMode === 'phone' ? 'bg-white text-amber-800 dark:bg-zinc-700 dark:text-amber-200' : 'text-amber-500 hover:text-amber-700 dark:text-amber-400 dark:hover:text-amber-200'"
      ...
      <form v-show="registerMode === 'email'" @submit.prevent="handleEmailRegister" novalidate>
        <!-- 邮箱输入框 -->
        <div class="mb-4">
          <label for="reg-email" class="block text-xs font-semibold text-amber-700 dark:text-amber-200 tracking-wide mb-1.5">
            邮箱
          </label>
          <div class="relative">
        ...
        <!-- 密码输入框 -->
        <div class="mb-4">
          <label for="reg-password" class="block text-xs font-semibold text-amber-700 dark:text-amber-200 tracking-wide mb-1.5">
            密码
          </label>
          <div class="relative">
            <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-amber-400 dark:text-amber-300">
        ...
        <!-- 邮箱验证码 -->
        <div class="mb-5">
          <label for="reg-code" class="block text-xs font-semibold text-amber-700 dark:text-amber-200 tracking-wide mb-1.5">
            邮箱验证码（9 位数字+英文混合）
          </label>
          <div class="flex gap-2">
            ...
            <button
              ...
              :class="emailCodeCountdown > 0 ? 'bg-amber-100 text-amber-500 cursor-not-allowed dark:bg-zinc-800 dark:text-amber-300' : 'bg-amber-600 text-white hover:bg-amber-700 active:bg-amber-800 focus:ring-amber-400 active:scale-[0.97]'"
        ...
        <button
          ...
          :class="emailLoading ? 'opacity-70 cursor-not-allowed' : 'hover:bg-amber-800 active:bg-amber-900 active:scale-[0.98]'"
          :disabled="emailLoading"
        >
      ...
      <form v-show="registerMode === 'phone'" @submit.prevent="handlePhoneRegister" novalidate>
        <!-- 手机号输入框 -->
        <div class="mb-4">
          <label for="reg-phone" class="block text-xs font-semibold text-amber-700 dark:text-amber-200 tracking-wide mb-1.5">
            手机号码
          </label>
          <div class="relative">
            <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-amber-400 dark:text-amber-300">
        ...
        <!-- 短信验证码 -->
        <div class="mb-4">
          <label for="reg-phone-code" class="block text-xs font-semibold text-amber-700 dark:text-amber-200 tracking-wide mb-1.5">
            短信验证码
          </label>
          <div class="flex gap-2">
            <input
        ...
        <!-- 设置密码 -->
        <div class="mb-5">
          <label for="reg-phone-password" class="block text-xs font-semibold text-amber-700 dark:text-amber-200 tracking-wide mb-1.5">
            设置密码
          </label>
          <div class="relative">
            <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-amber-400 dark:text-amber-300">
      ...
      <div class="my-6 flex items-center gap-3">
        ...
        <span class="text-xs text-amber-400 dark:text-amber-500 whitespace-nowrap">或使用第三方账号注册</span>
        <div class="flex-1 h-px bg-amber-200 dark:bg-zinc-600"></div>
      </div>
