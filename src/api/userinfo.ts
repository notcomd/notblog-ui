...
export function consumeCoins(amount: number) {
...
export async function uploadUserCover(file: File, onProgress?: (percent: number) => void) {
...
async function uploadCoverByChunks(file: File, onProgress?: (percent: number) => void) {
