...
const TYPE_META: Record<string, NotificationMeta> = {
  ...
  TweetCoined: {
    name: '互动通知',
    icon: '<circle cx="12" cy="12" r="9" /><path d="M12 7v10M9.5 9.5c.5-.7 1.4-1 2.5-1s2 .3 2.5 1c.6.8.2 1.8-1.2 2.3-1.8.6-2.4 1.5-1.8 2.4.5.8 1.5 1.1 2.5 1s2-.4 2.5-1.2" />',
    bg: 'bg-amber-100 dark:bg-amber-500/20',
    fg: 'text-amber-600 dark:text-amber-300'
  },
  TweetShared: {
  ...
  CircleInvited: {
    name: '圈子通知',
    icon: '<path d="M12 3l9 18H3z" /><path d="M8 14l4-5 4 5" />',
